...
class ThreadMessagePaginate {
  Meta? meta;
  List<ThreadMessageModel>? messages;

  ThreadMessagePaginate({this.meta , this.messages});

  ThreadMessagePaginate.fromJson(Map<String, dynamic> json) {
    meta = json['meta'] != null ? Meta.fromJson(json['meta']) : null;
    messages =[];
  if (json['data']!=null) {
    Iterable data = json['data'];
    messages = data.map((post)=>ThreadMessageModel.fromJson(post)).toList();
  }
  }
